...
public final class BookEntry {
     ...
     * For that it will check individually if all the private fields of both objects are the same after some intial checks (like verifying if they have the same reference of if they are of the same Class)
     *
    ...
    /**
     * Overridden Public Method that is used to transform an instance of this class into a String, being able to use the method System.out.prinln with the objcts of this class.
     *
