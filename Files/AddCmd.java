 ...
 * This LibraryData contains a field that it is a List of book Entries and it will be updated with the information of the databese.
 */
...
public class AddCmd extends LibraryCommand {
    ...
    /**
     * Constructor of the class that will call the constructor of the super class. This will call the method parseArguments to initialize the field parseArgument.
     *
     ...
     * In this class the method parseArguments is used to check if the given input is valid. for that it will check if the ending of the input is .csv.
    ...
    protected boolean parseArguments(String argumentInput) {
        ...
        if (argumentInput.endsWith(CSV_EXTENSION)) {
