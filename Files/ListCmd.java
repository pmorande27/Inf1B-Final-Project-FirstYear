...
/**
 * Clas for the Command LIST. This command is used to print all the books contained in a LibraryData, it has two formats: short, which includes only the titles of the books in the printing
...
public class ListCmd extends LibraryCommand {
     ...
     */
    private final String COMMAND_OPTION = "Command";
    /**
     ...
     * The super costructor will check if the given input is null and also it will call the method parseArgument to check if the given input is valid. (the overridden version)
     * @param argumentInput (String) Input given by the user, it should refer to the format of listing that the User wants (short or long). Therefore it should only take 3 possible values:short, long or blank(""),
     */
    ...
    /**
     * Overridden Method from the abstact method of the superClass.
     ...
     * This mehtod is used to iterate over the List of BookEntries contained in a given libraryData and to print the content of the BookEntries according to the format given by the user.
     * @param books is the list of bookEntries contained in the given Library. It must not be empty to enter to this method.
     * @throws IllegalArgumentException if the command is not equivalent to one of the accepted commands, that would mean that an error has occurred during parsing
     */
    ...
    /**
     * Helper Method of parseArgumetns that is used to chcek if there is a correspondence between the given input and the allowed formats
     * If it is blank then the command will be equal to the CommandOptionsList shortCommand, if the argument Input is short then the command will be equal to the CommandOptionList shortCommand and if the argument input is equal to long the command will be equal to longCommand. Other option will return false.
     * @param ArgumentInput argument input for this command
